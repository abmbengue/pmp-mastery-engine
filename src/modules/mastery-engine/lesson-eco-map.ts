...
export const LESSON_ECO_MAP: readonly LessonEcoMapEntry[] = [
  ...
  m(
    ...
    3,
    "INSTRUCTOR_DERIVED",
    "Closure vehicle — Instructor Lesson 10 blueprint (depth still thin in PLA body)"
  ),
  ...
  m("scope", "PROCESS-T02", "PRIMARY", 4, "INSTRUCTOR_DERIVED"),
  m("requirements-basics", "PROCESS-T02", "SECONDARY", 3, "INSTRUCTOR_DERIVED"),
  ...
  m("issue-management", "BUSINESS-T04", "PRIMARY", 4, "INSTRUCTOR_DERIVED"),
  m("quality", "PROCESS-T07", "PRIMARY", 5, "INSTRUCTOR_DERIVED", "Instructor Lesson 5 — QA≠QC"),
  m("change-management-basics", "BUSINESS-T03", "PRIMARY", 4, "INSTRUCTOR_DERIVED"),
  ...
  m("lessons-learned", "PROCESS-T10", "SECONDARY", 3, "INSTRUCTOR_DERIVED"),

  // —— Business ——
  m("governance", "BUSINESS-T01", "PRIMARY", 4, "INSTRUCTOR_DERIVED", "Instructor Lesson 2"),
  m("compliance", "BUSINESS-T02", "PRIMARY", 4, "INSTRUCTOR_DERIVED", "Instructor Lesson 3 — conformité"),
  ...
  m("business-value", "PROCESS-T03", "PRIMARY", 4, "INSTRUCTOR_DERIVED"),
  ...
  m("definition-of-done", "PROCESS-T02", "SUPPORTING", 2, "INSTRUCTOR_DERIVED"),
  ...
  m("risk-management-hybrid", "BUSINESS-T05", "PRIMARY", 4, "INSTRUCTOR_DERIVED"),
...
export const LESSON_AUDIT: readonly LessonAuditRow[] = [
  ...
  { lessonId: "scope", auditClass: "PRIMARY", primaryEcoTasks: ["PROCESS-T02"], notes: "Instructor Lesson 3 blueprint" },
  ...
  { lessonId: "project-lifecycle-basics", auditClass: "THIN", primaryEcoTasks: ["PROCESS-T10"], notes: "Closure PRIMARY — content depth still thin; blueprint L10 available" },
