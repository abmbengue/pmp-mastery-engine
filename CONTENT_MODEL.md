...
Short Learning = VIDEO with `isShort: true` and duration ≤ ~180 seconds. Media resolved via `MediaProvider` (placeholder or external URL). No mandatory paid hosting.
