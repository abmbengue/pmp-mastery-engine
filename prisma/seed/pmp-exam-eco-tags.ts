...
/** Primary processArea → ECO-proxy task (PLA heuristic). */
const PROCESS_AREA_PRIMARY: Record<string, EcoTagPatch> = {
  ...
  /**
   * Bank tags Risk under PROCESS domain historically; ECO 2026 places risk under
   * business environment. We tag BE-05 without rewriting domain/stems (Phase C+).
   */
  Risk: {
    ecoTaskCode: "BE-05",
  ...
  /**
   * Change control similarly lives under BE in ECO 2026.
   */
  "Change control": {
    ecoTaskCode: "BE-03",
