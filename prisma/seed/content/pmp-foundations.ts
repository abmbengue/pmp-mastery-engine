...
export const PMP_FOUNDATIONS_LESSONS: PmpLesson[] = [
  ...
  buildPmpLesson({
    ...
    question: q({
      type: "SINGLE_CHOICE",
      promptFr: "Qui coordonne le travail quotidien du projet Helios CRM ?",
      promptEn: "Who coordinates day-to-day work on the Helios CRM project?",
      explanationCorrectFr: "Le chef de projet coordonne ; le sponsor arbitre et débloque.",
      explanationCorrectEn: "The project manager coordinates; the sponsor arbitrates and unblocks.",
      difficulty: 1,
      options: [
        opt("Le sponsor", "The sponsor", false, "Le sponsor finance et débloque — pas la coordination quotidienne.", "The sponsor funds and unblocks — not day-to-day coordination."),
        opt("Le chef de projet", "The project manager", true),
        opt("L'équipe seule, sans PM", "The team alone, without a PM", false, "L'équipe livre ; le PM coordonne transversalement.", "The team delivers; the PM coordinates cross-functionally."),
        opt("Le comité de direction", "The steering committee", false, "Le comité arbitre au niveau portfolio — pas le quotidien.", "The committee decides at portfolio level — not daily work."),
      ],
    }),
  }),
