/**
 * Corporate Finance content factory — rich micro-learning bodies (FR/EN).
...
const DISCLAIMER_FR =
  "Normes comptables, fiscales et de reporting varient selon les pays. Contenu pédagogique — pas une valorisation professionnelle ni un conseil en investissement.";
const DISCLAIMER_EN =
  "Accounting, tax, and reporting standards vary by country. Educational content — not a professional valuation or investment advice.";

export function buildCfLesson(input: CfLessonInput): CompactLesson {
...
export function opt(
  ...
  return {
    ...
    ...(isCorrect
      ...
      : {
          explanationWrongFr:
            whyFr ?? "Cette option est moins appropriée. Relisez l'exemple chiffré du mini-cas.",
          explanationWrongEn:
            whyEn ?? "This option is less appropriate. Re-read the mini-case numbers.",
        }),
  };
}

export { q as cfQ, opt as cfOpt, buildCfLesson as cfLesson };
